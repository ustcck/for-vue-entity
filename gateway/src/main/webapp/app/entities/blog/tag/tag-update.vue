    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="gatewayApp.blogTag.home.createOrEditLabel" v-text="$t('gatewayApp.blogTag.home.createOrEditLabel')">Create or edit a Tag</h2>
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div v-if="$v.tag.name.$anyDirty && $v.tag.name.$invalid">
                            ...
                            <small class="form-text text-danger" v-if="!$v.tag.name.minLength" v-bind:value="$t('entity.validation.minlength')">
