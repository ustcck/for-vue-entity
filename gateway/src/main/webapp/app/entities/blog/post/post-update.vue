    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="gatewayApp.blogPost.home.createOrEditLabel" v-text="$t('gatewayApp.blogPost.home.createOrEditLabel')">Create or edit a Post</h2>
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div v-if="$v.post.date.$anyDirty && $v.post.date.$invalid">
                            ...
                            <small class="form-text text-danger" v-if="!$v.post.date.ZonedDateTimelocal" v-text="$t('entity.validation.ZonedDateTimelocal')">
                                This field should be a date and time.
                            </small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" v-bind:value="$t('gatewayApp.blogPost.blog')" for="post-blog">Blog</label>
