    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="gatewayApp.blogBlog.home.createOrEditLabel" v-text="$t('gatewayApp.blogBlog.home.createOrEditLabel')">Create or edit a Blog</h2>
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div v-if="$v.blog.name.$anyDirty && $v.blog.name.$invalid">
                            ...
                            <small class="form-text text-danger" v-if="!$v.blog.name.minLength" v-bind:value="$t('entity.validation.minlength')">
                    ...
                    <div class="form-group">
                        ...
                        <div v-if="$v.blog.handle.$anyDirty && $v.blog.handle.$invalid">
                            ...
                            <small class="form-text text-danger" v-if="!$v.blog.handle.minLength" v-bind:value="$t('entity.validation.minlength')">
                                This field is required to be at least 2 characters.
                            </small>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-control-label" v-bind:value="$t('gatewayApp.blogBlog.user')" for="blog-user">User</label>
