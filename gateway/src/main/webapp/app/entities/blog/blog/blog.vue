    ...
    <div>
        <h2 id="page-heading">
            ...
            <router-link :to="{name: 'BlogCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-blog">
                ...
                <span  v-text="$t('gatewayApp.blogBlog.home.createLabel')">
                    Create a new Blog
                </span>
            </router-link>
        </h2>
        ...
        <div class="table-responsive" v-if="blogs && blogs.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('gatewayApp.blogBlog.name')">Name</span></th>
                    <th><span v-text="$t('gatewayApp.blogBlog.handle')">Handle</span></th>
                    <th><span v-text="$t('gatewayApp.blogBlog.user')">User</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="gatewayApp.blogBlog.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-blog-heading" v-bind:title="$t('gatewayApp.blogBlog.delete.question')">Are you sure you want to delete this Blog?</p>
            </div>
            <div slot="modal-footer">
                <button type="button" class="btn btn-secondary" v-text="$t('entity.action.cancel')" v-on:click="closeDialog()">Cancel</button>
                <button type="button" class="btn btn-primary" id="jhi-confirm-delete-blog" v-text="$t('entity.action.delete')" v-on:click="removeBlog()">Delete</button>
            </div>
        </b-modal>
    </div>
</template>
